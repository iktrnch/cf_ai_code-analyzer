/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 617330bfc66ed64ba3eca7f9b734679b)
// Runtime types generated with workerd@1.20260301.1 2026-03-06 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AnalysisAgent";
	}
	interface Env {
		AI: Ai;
		AnalysisAgent: DurableObjectNamespace<import("./src/index").AnalysisAgent>;
		ANALYSIS_WORKFLOW: Workflow<Parameters<import("./src/index").AlgorithmAnalysisWorkflow['run']>[0]['payload']>;
	}
}
